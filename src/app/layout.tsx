      ...
      <body>
        <main className="h-dvh flex flex-col items-center bg-[#171717] text-neutral-400 overflow-auto ">
          <div className="p-4 w-full max-w-[650px] flex items-start flex-col pt-4 md:pt-8 relative ">
            <div
              id="sticky-nav"
              className="sticky left-0 top-0 flex flex-row gap-4 z-50 w-full items-center justify-between backdrop-filter backdrop-blur-3xl bg-opacity-30 text-green-400 p-1.5 "
            >
